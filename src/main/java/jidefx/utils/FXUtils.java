...
public class FXUtils {
    ...
    /**
     * determine if the {@code Node} is the ancestorNode of another {@code Node}
     * or the same.
     *
     * @param node the node
    ...
    /**
     * Finds the ancestor of the node which is the type of the classToFind and
     * before it reaches a node that is of type classToStop.
     *
     * @param node the node that we will look for the ancestor.
     * @param classToFind the ancestor type we will try to look for
     * @param classToStop the ancestor type which will stop looking for further
     * if seeing a node of this type.
    ...
    /**
     * Finds the ancestor of the node which its type class name ends with String
     * classNameEndWith and before it reaches a node that is of type
     * classToStop.
     *
     * @param node the node that we will look for the ancestor.
     * @param classNameEndWith the ancestor class name that ends with this
     * String
     * @param classToStop the ancestor type which will stop looking for further
     * if seeing a node of this type.
     * @return the ancestor node if any.
    ...
    public interface Handler<T> {
        ...
        /**
         * The action you want to perform on this Node. This method will only be
         * called if {@link #condition(Object)} returns true.
         *
         * @param c the Node
         */
        void action(T c);
        ...
        /**
         * The action you want to perform to any Nodes. If action(c) is called,
         * this action is after it.
         *
         * @param c the Node.
         */
    ...
    public interface ConditionHandler<T> extends Handler<T> {
        ...
        /**
         * If this method returns true, the recursive call will stop at the Node
         * and the action will not be called on itself and its children.
         *
         * @param c the Node
         * @return true or false.
         */
     ...
     *      return action();
     *  }
     * }</pre>. Here is an example to get the first child of the specified type.
     * <pre>{@code
    ...
    public interface GetHandler<T> {
         ...
         *
         * @param c the Node
         * @return the Node that will be returned from
         * {@link FXUtils#getRecursively(Object, FXUtils.GetHandler)}.
         */
...
//    }
    /**
     * Runs the runnable using Platform.runLater if the current thread is not on
