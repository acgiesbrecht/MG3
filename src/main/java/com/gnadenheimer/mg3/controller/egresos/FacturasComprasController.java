...
private DaoBase<TblFacturasCompra> daoTblFacturasCompra = new DaoBase<>(TblFacturasCompra.class);
 ...
 @FXML private TableControl<TblFacturasCompra> masterTable;
 ...
 *
 ...
 @Override public TblFacturasCompra preInsert(TblFacturasCompra newRecord) {
 showFacturasCompraEdit(newRecord, Form.Mode.INSERT);

 return null;
 }

 @Override public boolean canEdit(TblFacturasCompra selectedRecord) {
 ...
 @Override public void doubleClick(TblFacturasCompra record) {
 showFacturasCompraEdit(record, Form.Mode.EDIT);
 }

 @Override public void delete(List<TblFacturasCompra> records) {
