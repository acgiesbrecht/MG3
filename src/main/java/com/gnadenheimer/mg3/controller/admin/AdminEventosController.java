 ...
 *
 ...
 import com.gnadenheimer.mg3.model.domain.TblEventos;
 import com.gnadenheimer.mg3.model.domain.TblGrupos;
...
import javafx.scene.control.TableColumn;
 ...
 @FXML private TableControl<TblEventos> eventosTable;
 ...
 *
 ...
 @Override public List<TblEventos> insert(List<TblEventos> newRecords) {
 return daoTblEventos.insert(newRecords);
 }

 @Override public TblEventos preInsert(TblEventos newRecord) {
 ...
 @Override public List<TblEventos> update(List<TblEventos> records) {
 return daoTblEventos.update(records);
 }

 /*
 @Override public boolean canDelete(TableControl table) {
 ...
 @Override public void delete(List<TblEventos> records) {
