...
public class TableColumnLocalDate<R> extends TableColumnBase<R, LocalDateTime> {

    public TableColumnLocalDate(String sText, String valuePropertyName, Double prefWith) {
