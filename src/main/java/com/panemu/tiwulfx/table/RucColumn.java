 ...
 * @author amrullah
 */
public class RucColumn<R extends Object> extends BaseColumn<R, String> {
    ...
    public RucColumn(String propertyName) {
        this(propertyName, 100);
    }

    public RucColumn(String propertyName, double preferredWidth) {
        ...
        Callback<TableColumn<R, String>, TableCell<R, String>> cellFactory
            ...
            public TableCell call(TableColumn p) {
                return new RucTableCell<R>(RucColumn.this);
            }
        };
    ...
    /**
     * Set maximum character that could be entered when editing a cell. Set it
     * to 0 to disable this limitation.
     *
     * @param maxLength
     */
    ...
    /**
     *
     * @return true if the cell editor automatically convert entered text to
     * capital letters
     */
    ...
    /**
     * Set whether text entered to a cell editor will be automatically converted
     * to capital letters.
     *
