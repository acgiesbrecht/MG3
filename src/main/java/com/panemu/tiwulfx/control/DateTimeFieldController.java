 ...
 */
public abstract class DateTimeFieldController {
     ...
     */
    public void onDisabledDateSelected(LocalDateTimeTextField dateField, LocalDateTime oldDate) {
        MessageDialogBuilder.error().message("date.disabled").show(dateField.getScene().getWindow());
        dateField.setLocalDateTime(oldDate);
    }
     ...
     */
    public abstract boolean isEnabled(LocalDateTime date);
}
